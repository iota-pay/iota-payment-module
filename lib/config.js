...
let config = {
  ...
  username: e.username || defaults.username,
  password: e.password || defaults.password,
  jwt_secret: e.jwt_secret || defaults.jwt_secret,
}
