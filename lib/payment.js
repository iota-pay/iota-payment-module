 ...
 * @param {value} [paymentInput.value] - iota value
 * @param {timeUntilConfirmation} [paymentInput.timeUntilConfirmation] - time in seconds until the payment is confirmed, independent of the received amount
 * @param {data} [paymentInput.data] - additional data
