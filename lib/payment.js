...
function getPayments() {
  return new Promise(async function(resolve, reject) {
    let payments = await get_payments()
    resolve(payments)
  })
}
...
function getOpenPayments() {
  return new Promise(async function(resolve, reject) {
    let openPayments = await get_open_payments()
    resolve(openPayments)
  })
}
...
function getPaymentByID(id) {
  return new Promise(async function(resolve, reject) {
    const payment = await get_payment({ id: id })
    resolve(payment)
  })
}
